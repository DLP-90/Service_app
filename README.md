...
The reason i choose these two particular programs is because flutter is a very popular application-creating program and SQLite creates databases that are optimal for offline use.
